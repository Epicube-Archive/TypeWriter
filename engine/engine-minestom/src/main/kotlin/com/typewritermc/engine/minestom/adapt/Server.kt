...
import com.typewritermc.engine.minestom.utils.findGlobalPlayerByUuid
...
class Server private constructor() {
    ...
    fun registerEvents(vararg listeners: com.typewritermc.engine.minestom.adapt.event.Listener) = listeners.forEach {
        EventListenerScanner.registerListeners(MinecraftServer.getGlobalEventHandler(), it)
    }

    fun registerSuspendingEvents(vararg listeners: com.typewritermc.engine.minestom.adapt.event.Listener) = listeners.forEach {
