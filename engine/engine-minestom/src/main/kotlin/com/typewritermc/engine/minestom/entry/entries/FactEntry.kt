...
interface FactEntry : StaticEntry {
    ...
    fun identifier(player: Player): FactId? {
        ...
        val groupId = if (entry != null) {
            ...
            com.typewritermc.engine.minestom.entry.entries.GroupId(player.uuid)
        }
...
@Tags("writable-fact")
interface WritableFactEntry : com.typewritermc.engine.minestom.entry.entries.FactEntry {
...
@Tags("cachable-fact")
interface CachableFactEntry : com.typewritermc.engine.minestom.entry.entries.ReadableFactEntry,
    com.typewritermc.engine.minestom.entry.entries.WritableFactEntry {

    override fun readForGroup(groupId: com.typewritermc.engine.minestom.entry.entries.GroupId): FactData {
...
interface PersistableFactEntry : com.typewritermc.engine.minestom.entry.entries.CachableFactEntry {
    fun canPersist(id: FactId, data: FactData): Boolean = true
}

@Tags("expirable-fact")
interface ExpirableFactEntry : com.typewritermc.engine.minestom.entry.entries.CachableFactEntry {
