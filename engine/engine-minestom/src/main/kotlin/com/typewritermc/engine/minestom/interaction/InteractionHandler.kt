...
import com.typewritermc.engine.minestom.entry.entries.Event
import com.typewritermc.engine.minestom.entry.entries.EventTrigger
...
class InteractionHandler : com.typewritermc.engine.minestom.adapt.event.Listener, KoinComponent {
    ...
    @com.typewritermc.engine.minestom.adapt.event.EventHandler(priority = -5)
    ...
    @com.typewritermc.engine.minestom.adapt.event.EventHandler(priority = 10)
